...
start java -jar selenium-server-standalone-3.9.1.jar -host 127.0.0.1 -port 4444 -role hub
start java -jar selenium-server-standalone-3.9.1.jar  -host 127.0.0.1 -port 4458 -role node  -hub http://127.0.0.1:4444/grid/register -hubHost 127.0.0.1 -hubPort 4444 -browser  "browserName=internet explorer,version=11,platform=WINDOWS,maxInstances=10"
